...
\chapter{Projekt demonstratora systemu kierowania} 

\section{CAD i modelowanie 3D}
\subsection{Modelowanie mechaniczne i analiza kinematyczna}

\section{Elektronika}
\subsection{Dobór komponentów}
\subsection{Schemat podłączeń i opis funkcjonalny układu sterowania}

\section{Oprogramowanie i algorytmy sterowania}
\subsection{Architektura oprogramowania}
\subsection{Implementacja komunikacji}
\subsection{Implementacja algorytmów detekcji i śledzenia}
\subsection{Implementacja algorytmów sterowania silnikami}
\subsection{Symulacja dynamiki i optymalizacja parametrów}
